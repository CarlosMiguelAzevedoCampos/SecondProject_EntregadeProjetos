...
namespace CMA.ISMAI.Delivery.FileLoading.IntegrationTests
{
    public class FileIdentifier_IntegrationTests
    {
        ...
        [Trait("CreateFileIdentifiersCommand", "FileIdentifiers")]
        public async Task IdentifiersCreated()
        {
            // Arrange
            var services = ConfigureServices();
            var serviceProvider = services.BuildServiceProvider();
            CreateFileIdentifiersCommand createFileIdentifiersCommand = new CreateFileIdentifiersCommand(Guid.NewGuid(), @"C:\Users\Carlos Campos\Desktop\Teste\Unzip\A029216_ISMAI_Carlos Campos_Informática", "carlosmiguelcampos1996@gmail.com");
        ...
        public async Task FilePathNotFound()
        {
            ...
            var services = ConfigureServices();
            var serviceProvider = services.BuildServiceProvider();
            CreateFileIdentifiersCommand createFileIdentifiersCommand = new CreateFileIdentifiersCommand(Guid.NewGuid(), @"C:\Users\Carlos Campos\Desktop\Unzip\A029216_ISMAI_Carlos Campos_Informática", "carlosmiguelcampos1996@gmail.com");
