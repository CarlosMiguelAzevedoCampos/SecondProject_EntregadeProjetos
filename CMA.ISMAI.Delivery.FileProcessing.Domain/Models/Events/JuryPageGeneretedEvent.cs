...
{
    public class JuryPageGeneretedEvent : Event
    {
        public JuryPageGeneretedEvent(string studentName, string studentNumber, string studentCourseName, string studentInstituteName, string filePath)
        {
