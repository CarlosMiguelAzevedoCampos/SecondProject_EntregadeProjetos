    ...
    internal class ConsoleApplication
    {
        ...
        private void Consumer_Received(object sender, BasicDeliverEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _notificationService.SendEmail(_config.GetSection("Notification:Email").Value, string.Format("Olá!, <br/> <br/> Uma entrega falhou a inicar no Diagrama FileProcessing! <br/> <br/>  Os items são: " +
            ...
            catch (Exception ex)
            {
                ...
                _notificationService.SendEmail(_config.GetSection("Notification:Email").Value, string.Format("Olá!, <br/> <br/> Uma entrega falhou a inicar no Diagrama FileProcessing! <br/> <br/> Aqui tem o JSON com a informação {0} <br/><br/> Thanks.", JsonConvert.SerializeObject(notification)));
            }
        }
    }
}