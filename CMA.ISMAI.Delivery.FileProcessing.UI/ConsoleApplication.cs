    ...
    internal class ConsoleApplication
    {
        ...
        private void Consumer_Received(object sender, BasicDeliverEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    _notificationService.SendEmail(_config.GetSection("Notification:Email").Value, string.Format("Hey!, <br/> <br/> An delivery failed to start on FileProcessing workflow! <br/> <br/>  Is delivery items are: " +
            ...
            catch (Exception ex)
            {
                ...
                _notificationService.SendEmail(_config.GetSection("Notification:Email").Value, string.Format("Hey!, <br/> <br/> An delivery failed to start on FileProcessing workflow! <br/> <br/> Heres the JSON object {1} <br/><br/> Thanks.", JsonConvert.SerializeObject(notification)));
            }
        }
    }
}