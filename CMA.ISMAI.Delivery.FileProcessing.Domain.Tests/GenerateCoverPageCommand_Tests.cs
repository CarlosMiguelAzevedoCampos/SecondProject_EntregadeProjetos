...
namespace CMA.ISMAI.Delivery.FileProcessing.Domain.Tests
{
    public class GenerateCoverPageCommand_Tests
    {
        ...
        public void FailToGenerateCover()
        {
            ...
            var generateCoverPageCommand = new GenerateCoverPageCommand(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>());
            coverProcessor.Setup(x => x.AddCoverPage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(false);
            // Act
        ...
        public void GenerateCover()
        {
            ...
            var fileTransfer = new Mock<IFileTransferService>();
            var generateCoverPageCommand = new GenerateCoverPageCommand(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>());
            coverProcessor.Setup(x => x.AddCoverPage(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(true);
            // Act
            var fileHandler = new FileProcessingHandler(pdfProcessor.Object, coverProcessor.Object, generateJuryPage.Object, fileReader.Object, meditrHandler.Object, fileTransfer.Object);
            var result = fileHandler.Handle(generateCoverPageCommand, new CancellationToken());
